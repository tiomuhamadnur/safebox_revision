                ...
                <div class="card card-stats">
                    <div class="card-body ">
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    <p class="card-category">Alat Expired</p>
                                    <p class="card-title">
                                        <!-- {{ $invalid->count() }}  -->
                                    <p>
                                </div>
                ...
                <div class="card card-stats">
                    <div class="card-body ">
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    <p class="card-category">Sirkulasi</p>
                                    <p class="card-title">
                                        <!-- {{ $pegawai->count() }} -->
                                    <p>
                                </div>
                ...
                <div class="card card-stats">
                    <div class="card-body ">
                        <div class="row">
                            <div class="col-5 col-md-4">
                                <div class="icon-big text-center icon-warning">
                                    <i class="nc-icon nc-minimal-down text-success"></i>
                                </div>
                            </div>
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    <p class="card-category">Kembali</p>
                                    <p class="card-title">
                                        <!-- {{ $alat->count() }} -->
                                    <p>
                                </div>
                ...
                <div class="card card-stats">
                    <div class="card-body ">
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    <p class="card-category">Pinjam</p>
                                    <p class="card-title">
                                        <!-- {{ $alat_rusak->count() }} -->
                                    <p>
                                </div>
                ...
                <div class="card card-stats">
                    <div class="card-body ">
                        <div class="row">
                            <div class="col-5 col-md-4">
                                <div class="icon-big text-center icon-warning">
                                    <i class="nc-icon nc-touch-id text-primary"></i>
                                </div>
                            </div>
                            <div class="col-7 col-md-8">
                                <div class="numbers">
